...
export const BUSINESS_MIGRATION_SUPPORTED_VERSIONS: readonly [2, 3, 4];
...
export type MigrationVersion = 2 | 3 | 4;
...
export type MigrationRecordSummary = {
  index: number;
  kind: "vault" | "directory" | "run" | "run-deletion" | "manifest";
  name: string;
  bytes: number;
  sha256: string;
};
...
export function createMigrationHeader(createdAt?: Date, version?: MigrationVersion): MigrationHeader;
